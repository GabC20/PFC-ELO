...
training_img_folder = '/home/gabriel_carvalho/teste/val3'
...
while True:
    ...
    # cv2.rectangle(image, (50, 50), (550, 550), (255, 255, 255), 2)

    #Start capturing pictures when user presses 's' key
    if click:
        region_of_interest = image
        # region_of_interest = image[50:550, 50:550]
        save_path = os.path.join(label_name, '{}.jpg'.format(image_name + 1))
        region_of_interest = cv2.resize(region_of_interest, (224,224))
